...
hi clear
let g:colors_name = 'MutedMonokai'
...
hi StatusLine guifg=#ffffff guibg=#5f5f87 gui=bold cterm=bold
hi StatusLineNC guifg=#d7d7ff guibg=#2f2f2f gui=reverse cterm=reverse
...
if s:t_Co >= 256
  ...
  hi StatusLineNC ctermfg=245 ctermbg=235 cterm=reverse
